...
def get_api(api, scope, service_account=True):
    ...
    STORAGE = file.Storage('NLP-ML-b131aba57563.json') #local storage of oAuth tokens
    ...
    """
    #client_email = '575046039409-icprmjeoub0f0lm517804ena2arm73a0@developer.gserviceaccount.com'
